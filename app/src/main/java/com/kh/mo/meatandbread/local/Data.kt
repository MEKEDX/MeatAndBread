...
class Data(context: Context?) {
    val listOfHawawshi: List<Meal> = listOf(
        Meal(1,
            ...
            context?.getString(R.string.mealQuantityHwa).toString(), Constants.hwa
        ),
        Meal(2,
            R.drawable.haw7, context?.getString(R.string.hwa2).toString(), 1, 25,
            context?.getString(R.string.hwa2Details).toString(),
            context?.getString(R.string.mealQuantityHwa).toString(), Constants.hwa
        ),
        Meal(3,
            R.drawable.haw2, context?.getString(R.string.hwa3).toString(), 1, 30,
            context?.getString(R.string.hwa3Details).toString(),
            context?.getString(R.string.mealQuantityHwa).toString(), Constants.hwa
        ),
        Meal(4,
            R.drawable.haw8, context?.getString(R.string.hwa4).toString(), 1, 30,
            context?.getString(R.string.hwa4Details).toString(),
            context?.getString(R.string.mealQuantityHwa).toString(), Constants.hwa
        ),
        Meal(5,
            R.drawable.haw1, context?.getString(R.string.hwa5).toString(), 1, 30,
            context?.getString(R.string.hwa5Details).toString(),
            context?.getString(R.string.mealQuantityHwa).toString(), Constants.hwa
        ),
        Meal(6,
            R.drawable.haw5, context?.getString(R.string.hwa6).toString(), 1, 35,
    ...
    val listOfMeat: List<Meal> = listOf(
        Meal(7,
            R.drawable.meat1,
            context?.getString(R.string.meat1).toString(),
            250,
            78,
        ...
        Meal(8,
            R.drawable.meat2,
            context?.getString(R.string.meat2).toString(),
            250,
            78,
        ...
        Meal(9,
            R.drawable.meat3,
            context?.getString(R.string.meat3).toString(),
            250,
            78,
        ...
        Meal(10,
            R.drawable.meat4,
            context?.getString(R.string.meat4).toString(),
            250,
            75,
        ...
        Meal(11,
            R.drawable.meat5,
            context?.getString(R.string.meat5).toString(),
            250,
            75,
        ...
        Meal(12,
            R.drawable.meat6,
            context?.getString(R.string.meat6).toString(),
            250,
            60,
        ...
        Meal(13,
            R.drawable.meat7,
            context?.getString(R.string.meat7).toString(),
            250,
            75,
        ...
        Meal(14,
            R.drawable.meat8,
            context?.getString(R.string.meat8).toString(),
            250,
            75,
        ...
        Meal(15,
            R.drawable.meat9,
            context?.getString(R.string.meat9).toString(),
            250,
            78,
        ...
        Meal(16,
            R.drawable.meat10,
            context?.getString(R.string.meat10).toString(),
            250,
            78,
        ...
        Meal(17,
            R.drawable.meat11,
            context?.getString(R.string.meat11).toString(),
            250,
            60,
    ...
    val listOfProcessedMeat: List<Meal> = listOf(
        Meal(18,
            R.drawable.kofta,
            context?.getString(R.string.kofta).toString(),
            500,
            80,
        ...
        Meal(19,
            R.drawable.burger,
            context?.getString(R.string.burger).toString(),
            500,
            85,
